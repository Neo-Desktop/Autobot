...
sub installmods
{
    ...
    if (lc $response eq 'y') {
        ...
        println 'Available modules: Badwords, Bitly, BotStats, Calc, ChanTopics, Dictionary, EightBall, Eval, FML, Greet, HelloChan, IsItUp, LinkTitle, Oper, QDB, SASLAuth, UNO, Weather';
        print '> ';
